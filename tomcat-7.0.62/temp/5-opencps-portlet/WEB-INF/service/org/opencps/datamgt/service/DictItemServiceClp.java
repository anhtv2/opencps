 ...
 * @generated
 */
public class DictItemServiceClp implements DictItemService {
	public DictItemServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "getDictItem";

		_methodParameterTypes3 = new String[] { "long" };

		_methodName4 = "getDictItemsByParentItemId";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getDictItemsByDictCollectionId";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "getDictItemsInUseByDictCollectionIdAndParentItemId";
	...
	public org.opencps.datamgt.model.DictItem getDictItem(long dictItemId)
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					_methodParameterTypes3, new Object[] { dictItemId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<org.opencps.datamgt.model.DictItem> getDictItemsByParentItemId(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName4,
					_methodParameterTypes4, new Object[] { parentItemId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<org.opencps.datamgt.model.DictItem> getDictItemsByDictCollectionId(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName5,
					_methodParameterTypes5, new Object[] { dictCollectionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
