...
/**
 * The base model interface for the JobPos service. Represents a row in the &quot;opencps_jobpos&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link org.opencps.usermgt.model.impl.JobPosModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link org.opencps.usermgt.model.impl.JobPosImpl}.
 * </p>
 *
 * @author khoavd
 * @see JobPos
...
public interface JobPosModel extends BaseModel<JobPos> {
	...
	@Override
	public CacheModel<org.opencps.usermgt.model.JobPos> toCacheModel();
