 ...
 * {@link org.opencps.processmgt.service.impl.ServiceProcessLocalServiceImpl} and is the
...
public class ServiceProcessLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link org.opencps.processmgt.service.impl.ServiceProcessLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static org.opencps.processmgt.model.ServiceProcess addServiceProcess(
	...
	*/
	public static org.opencps.processmgt.model.ServiceProcess createServiceProcess(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.opencps.processmgt.model.ServiceProcess deleteServiceProcess(
		long serviceProcessId)
	...
	*/
	...
	public static org.opencps.processmgt.model.ServiceProcess fetchServiceProcess(
		long serviceProcessId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.opencps.processmgt.model.ServiceProcess getServiceProcess(
		long serviceProcessId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<org.opencps.processmgt.model.ServiceProcess> getServiceProcesses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.opencps.processmgt.model.ServiceProcess updateServiceProcess(
		org.opencps.processmgt.model.ServiceProcess serviceProcess)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	public static java.util.List<org.opencps.processmgt.model.ServiceProcess> searchProcess(
		...
		return getService().searchProcess(groupId, keywords, start, end);
	}
	...
	*/
	public static int countProcess(long groupId, java.lang.String keywords) {
		return getService().countProcess(groupId, keywords);
	}
	...
	*/
	public static org.opencps.processmgt.model.ServiceProcess updateProcess(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateProcess(serviceProcessId, processNo, processName,
			dossierTemplateId, description);
	}
	...
	* @throws SystemException
	*/
	public static org.opencps.processmgt.model.ServiceProcess addProcess(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addProcess(processNo, processName, description,
			dossierTemplateId, context);
	}

	public static java.util.List<org.opencps.processmgt.model.ServiceProcess> getServiceProcesses(
		long groupId, long dossierTemplateId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getServiceProcesses(groupId, dossierTemplateId);
	}

	public static int countByG_T(long groupId, long dossierTemplateId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().countByG_T(groupId, dossierTemplateId);
	}
	...
	public static ServiceProcessLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					ServiceProcessLocalService.class.getName());

			if (invokableLocalService instanceof ServiceProcessLocalService) {
				_service = (ServiceProcessLocalService)invokableLocalService;
			}
			else {
				_service = new ServiceProcessLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(ServiceProcessLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(ServiceProcessLocalService service) {
	}

	private static ServiceProcessLocalService _service;
}