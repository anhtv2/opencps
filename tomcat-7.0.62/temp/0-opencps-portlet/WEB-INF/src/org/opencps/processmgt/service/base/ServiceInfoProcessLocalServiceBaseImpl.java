...
import org.opencps.processmgt.service.ServiceInfoProcessLocalService;
...
/**
 * Provides the base implementation for the service info process local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.processmgt.service.impl.ServiceInfoProcessLocalServiceImpl}.
 * </p>
 *
 * @author khoavd
 ...
 * @generated
 */
public abstract class ServiceInfoProcessLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ServiceInfoProcessLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.processmgt.service.ServiceInfoProcessLocalServiceUtil} to access the service info process local service.
	 */
	...
	@Override
	public ServiceInfoProcess addServiceInfoProcess(
		ServiceInfoProcess serviceInfoProcess) throws SystemException {
		serviceInfoProcess.setNew(true);

		return serviceInfoProcessPersistence.update(serviceInfoProcess);
	}
	 ...
	 */
	@Override
	public ServiceInfoProcess createServiceInfoProcess(
		ServiceInfoProcessPK serviceInfoProcessPK) {
		return serviceInfoProcessPersistence.create(serviceInfoProcessPK);
	}
	...
	@Override
	public ServiceInfoProcess deleteServiceInfoProcess(
		ServiceInfoProcessPK serviceInfoProcessPK)
		throws PortalException, SystemException {
		return serviceInfoProcessPersistence.remove(serviceInfoProcessPK);
	}
	...
	public ServiceInfoProcess deleteServiceInfoProcess(
		ServiceInfoProcess serviceInfoProcess) throws SystemException {
		return serviceInfoProcessPersistence.remove(serviceInfoProcess);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ServiceInfoProcess.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return serviceInfoProcessPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return serviceInfoProcessPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ServiceInfoProcess fetchServiceInfoProcess(
		ServiceInfoProcessPK serviceInfoProcessPK) throws SystemException {
		return serviceInfoProcessPersistence.fetchByPrimaryKey(serviceInfoProcessPK);
	}
	 ...
	 */
	@Override
	public ServiceInfoProcess getServiceInfoProcess(
		ServiceInfoProcessPK serviceInfoProcessPK)
		throws PortalException, SystemException {
		return serviceInfoProcessPersistence.findByPrimaryKey(serviceInfoProcessPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return serviceInfoProcessPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ServiceInfoProcess> getServiceInfoProcesses(int start, int end)
		throws SystemException {
		return serviceInfoProcessPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getServiceInfoProcessesCount() throws SystemException {
		return serviceInfoProcessPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ServiceInfoProcess updateServiceInfoProcess(
		ServiceInfoProcess serviceInfoProcess) throws SystemException {
		return serviceInfoProcessPersistence.update(serviceInfoProcess);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.opencps.processmgt.model.ServiceInfoProcess",
			serviceInfoProcessLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = serviceInfoProcessPersistence.getDataSource();
	...
	private ServiceInfoProcessLocalServiceClpInvoker _clpInvoker = new ServiceInfoProcessLocalServiceClpInvoker();
}