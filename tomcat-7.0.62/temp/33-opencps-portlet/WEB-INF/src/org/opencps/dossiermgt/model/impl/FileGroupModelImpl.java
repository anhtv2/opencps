...
public class FileGroupModelImpl extends BaseModelImpl<FileGroup>
	...
	public static long FILEGROUPID_COLUMN_BITMASK = 4L;
	...
	public CacheModel<FileGroup> toCacheModel() {
		...
		fileGroupCacheModel.uuid = getUuid();

		String uuid = fileGroupCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			fileGroupCacheModel.uuid = null;
		}
