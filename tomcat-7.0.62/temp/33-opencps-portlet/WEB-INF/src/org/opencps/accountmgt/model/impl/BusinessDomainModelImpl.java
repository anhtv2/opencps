...
public class BusinessDomainModelImpl extends BaseModelImpl<BusinessDomain>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_acc_businessdomain (businessId LONG not null primary key,businessDomainId VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table opencps_acc_businessdomain";
	public static final String ORDER_BY_JPQL = " ORDER BY businessDomain.businessId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY opencps_acc_businessdomain.businessId ASC";
