...
/**
 * Provides the local service interface for BusinessAccount. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoavd
 * @see BusinessAccountLocalServiceUtil
...
public interface BusinessAccountLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BusinessAccountLocalServiceUtil} to access the business account local service. Add custom service methods to {@link org.opencps.accountmgt.service.impl.BusinessAccountLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
