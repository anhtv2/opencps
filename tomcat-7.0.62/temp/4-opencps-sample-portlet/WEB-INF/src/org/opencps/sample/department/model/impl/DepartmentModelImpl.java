...
import org.opencps.sample.department.model.DepartmentModel;
import org.opencps.sample.department.model.DepartmentSoap;
...
/**
 * The base model implementation for the Department service. Represents a row in the &quot;opencps_department&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link org.opencps.sample.department.model.DepartmentModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link DepartmentImpl}.
 * </p>
 *
 * @author trungnt
 * @see DepartmentImpl
 * @see org.opencps.sample.department.model.Department
 * @see org.opencps.sample.department.model.DepartmentModel
 * @generated
 */
@JSON(strict = true)
public class DepartmentModelImpl extends BaseModelImpl<Department>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a department model instance should use the {@link org.opencps.sample.department.model.Department} interface instead.
	 */
	public static final String TABLE_NAME = "opencps_department";
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_department (departmentId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,parentId LONG,name VARCHAR(75) null,description VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table opencps_department";
	public static final String ORDER_BY_JPQL = " ORDER BY department.name ASC";
	public static final String ORDER_BY_SQL = " ORDER BY opencps_department.name ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.org.opencps.sample.department.model.Department"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.org.opencps.sample.department.model.Department"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.org.opencps.sample.department.model.Department"));
	...
	public Object clone() {
		...
		departmentImpl.setParentId(getParentId());
	...
	public CacheModel<Department> toCacheModel() {
		...
		departmentCacheModel.parentId = getParentId();
