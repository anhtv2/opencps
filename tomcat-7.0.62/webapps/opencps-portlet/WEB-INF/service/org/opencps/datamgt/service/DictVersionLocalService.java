...
/**
 * Provides the local service interface for DictVersion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoavd
 * @see DictVersionLocalServiceUtil
...
public interface DictVersionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DictVersionLocalServiceUtil} to access the dict version local service. Add custom service methods to {@link org.opencps.datamgt.service.impl.DictVersionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
